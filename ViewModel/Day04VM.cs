...
namespace ViewModel
{
    public class Day04VM : INotifyPropertyChanged
    {
        private Day04Solver solver;
        ...
        {            
            RawInput = "";
            Solve04Command = new Solve04Command(this);
        }
        ...
        public Solve04Command Solve04Command { get; set; }
        ...
        internal void Solve(string[] input)
        {
            ...
            solver = new Day04Solver("LEANDRO");
