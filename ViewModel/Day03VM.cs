...
namespace ViewModel
{
    public class Day03VM : INotifyPropertyChanged
    {
        private Day03Solver solver;
        ...
        public Day03VM()
        {
            solver = new Day03Solver();

            RawInput = "";
            Solve03Command = new Solve03Command(this);
        }
        ...
        public Solve03Command Solve03Command { get; set; }
