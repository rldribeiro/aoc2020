        ...
        public static Wizard SummonWizard(string wizardName, int day)
        {
            ...
            switch (day)
            {
                ...
                case 10:                    
                    ...
                    if (wizardName.Equals(GONCALO)) return new Goncalo10(GONCALO);
                    break;
                case 11:
                    if (wizardName.Equals(GONCALO)) return new Goncalo11(GONCALO);
                    if (wizardName.Equals(LEANDRO)) return new Leandro11(LEANDRO);
                    break;
                case 12:
                    if (wizardName.Equals(GONCALO)) return new Goncalo12(GONCALO);
                    if (wizardName.Equals(LEANDRO)) return new Leandro12(LEANDRO);
                    break;
                case 13:
                    if (wizardName.Equals(GONCALO)) return new Goncalo13(GONCALO);
                    break;
            }
